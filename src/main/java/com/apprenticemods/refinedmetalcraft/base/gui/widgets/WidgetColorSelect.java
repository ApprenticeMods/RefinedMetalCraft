...
import com.apprenticemods.refinedmetalcraft.base.gui.event.MouseEnterEvent;
import com.apprenticemods.refinedmetalcraft.base.gui.event.MouseExitEvent;
...
public class WidgetColorSelect extends WidgetWithChoiceValue<Color> {
	...
	protected static final ResourceLocation BUTTON_TEXTURES = ResourceLocation.fromNamespaceAndPath(RefinedMetalCraft.MODID, "textures/gui/widgets.png");
